...
def run_test_practice_problem2a():
    ...
    print('--------------------------------------------------')
    expected = [9,11,14,8,11,4]
    nums = [2,4,7,1,4,-3]
    actual = practice_problem2a(nums, 7)
    print('expected', expected)
    print('actual', actual)

    expected = [-19,11,5,8,10]
    nums = [-20,10,4,7,9]
    actual = practice_problem2a(nums, 1)
    print('expected', expected)
    print('actual', actual)

    expected = [42,83,31,14,15]
    nums = [34,75,23,6,7]
    actual = practice_problem2a(nums, 8)
    print('expected', expected)
    print('actual', actual)
